...
const Aether = {
  'Thorin Battlehammer': {
    content: "Eden's Gate: Resurrection(Savage)", minItemLevel: '450', date: '2020-11-12', time: '12:00',
  },
  'Thorin BattleStorm': {
    content: "Eden's Gate: Descent(Savage)", minItemLevel: '450', date: '2020-11-13', time: '12:00',
  },
  'Thorin Battlehammer2': {
    content: "Eden's Gate: Inundation(Savage)", minItemLevel: '450', date: '2020-11-14', time: '12:00',
  },
  'Thorin BattleStorm2': {
    content: "Eden's Gate: Sepulture(Savage)", minItemLevel: '450', date: '2020-11-15', time: '12:00',
  },
  'Thorin Battlehammer3': {
    content: "Eden's Verse: Fulmination(Savage)", minItemLevel: '470', date: '2020-11-16', time: '12:00',
  },
  'Thorin BattleStorm3': {
    content: "Eden's Verse: Furor(Savage)", minItemLevel: '470', date: '2020-11-17', time: '12:00',
  },
  'Thorin Battlehammer4': {
    content: "Eden's Verse: Iconoclasm(Savage)", minItemLevel: '470', date: '2020-11-18', time: '12:00',
  },
  'Thorin BattleStorm4': {
    content: "Eden's Verse: Refulgence(Savage)", minItemLevel: '470', date: '2020-11-19', time: '12:00',
  },
  'Thorin Battlehammer5': {
    content: 'The Epic of Alexander (Ultimate)', minItemLevel: '470', date: '2020-11-20', time: '12:00',
  },
};
const Primal = {
  'Thorin Battlehammer': {
...
const addParty = (request, response, b) => {
  ...
  if (b.server === '/aether') {
    ...
    Aether[b.name].content = contentPicker(b.content.substring(0, 4));
    Aether[b.name].minItemLevel = b.minItemLevel;
    Aether[b.name].date = b.date;
    Aether[b.name].time = b.time;
    return responseCode;
  } if (b.server === '/primal') {
    if (Primal[b.name]) {
      responseCode = 204;
    ...
    Primal[b.name].content = contentPicker(b.content.substring(0, 4));
    Primal[b.name].minItemLevel = b.minItemLevel;
    Primal[b.name].date = b.date;
    Primal[b.name].time = b.time;
  } else {
    if (Crystal[b.name]) {
      responseCode = 204;
    } else {
    ...
    Crystal[b.name].content = contentPicker(b.content.substring(0, 4));
    Crystal[b.name].minItemLevel = b.minItemLevel;
    Crystal[b.name].date = b.date;
    Crystal[b.name].time = b.time;
  }
